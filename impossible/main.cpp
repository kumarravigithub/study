...
int main() {
    ...
    GLuint vaoFace1, vboFace1, eboFace1;
    
    glGenVertexArrays( 1, &vaoFace1 );
    glBindVertexArray( vaoFace1 );
    
    glGenBuffers( 1, &vboFace1 );
    glBindBuffer( GL_ARRAY_BUFFER, vboFace1 );
    glBufferData( GL_ARRAY_BUFFER, sizeof( verticesFace1 ), verticesFace1, GL_STATIC_DRAW );
    
    glGenBuffers( 1, &eboFace1 );
    glBindBuffer( GL_ELEMENT_ARRAY_BUFFER, eboFace1 );
    glBufferData( GL_ELEMENT_ARRAY_BUFFER, sizeof( indicesFace1 ), indicesFace1, GL_STATIC_DRAW );
